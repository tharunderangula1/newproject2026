  ...
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 dot-grid">
      ...
      >
        ...
        <motion.div variants={item} className="sm:hidden mt-12 mb-4">
        ...
        >
          ...
          <div className="relative h-[200px] w-[200px] sm:h-[220px] sm:w-[220px] md:h-[310px] md:w-[310px] lg:h-[350px] lg:w-[350px]">
        ...
        {/* Right — Content */}
        <div className="w-full flex flex-col items-center text-center sm:items-start sm:text-left sm:w-auto">
          {/* Badge */}
          <motion.div
            variants={item}
